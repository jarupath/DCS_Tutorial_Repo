...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <label>Ground Customer Service</label>
    <listPlacement>
    ...
    <pushNotifications>
        <pushNotification>
            <fieldNames>ATA_LT__c</fieldNames>
            <fieldNames>ATD_LT__c</fieldNames>
            <fieldNames>A_C_Reg__c</fieldNames>
            <fieldNames>BAY_ARR_DEP__c</fieldNames>
            <fieldNames>ETA_LT__c</fieldNames>
            <fieldNames>ETD_LT__c</fieldNames>
            <fieldNames>Flight_Date_LT__c</fieldNames>
            <fieldNames>Flight_Number__c</fieldNames>
            <fieldNames>Flight_Remark__c</fieldNames>
            <fieldNames>Name</fieldNames>
            <fieldNames>STA_LT__c</fieldNames>
            <fieldNames>STD_LT__c</fieldNames>
            <objectName>Flight__c</objectName>
        </pushNotification>
        <pushNotification>
            <fieldNames>Checkin_Seat__c</fieldNames>
            <fieldNames>Date_of_Birth_Display__c</fieldNames>
            <fieldNames>Travel_Document_Number__c</fieldNames>
            <objectName>Passenger__c</objectName>
        </pushNotification>
    </pushNotifications>
